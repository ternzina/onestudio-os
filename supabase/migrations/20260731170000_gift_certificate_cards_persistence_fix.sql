-- OneStudio OS
-- Gift certificate cards persistence fix.
-- Keeps gift_items and gift_image_urls during draft save and publish.
...
comment on function public.save_public_site_draft(
  ...
  'Persists public-site drafts including structured gift certificate cards.';
...
comment on function public.save_public_site_draft_v22(
  ...
  'Null-safe draft persistence including structured gift certificate cards.';
