-- OneStudio OS
-- Public Site Editor State Persistence 1.
--
-- The v22 normalizer remains the source of truth for validated fields.
-- This compatibility entry point additionally preserves the editor fields
-- that are not part of v22 yet: template, palette, layout and mobile title size.
...
comment on function public.save_public_site_draft(
  ...
  'Delegates validated fields to save_public_site_draft_v22 and preserves template, palette, layout order and mobile title settings.';
