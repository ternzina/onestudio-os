-- OneStudio OS
-- Hero + header foundation 1.0.
-- Persists header behaviour, logo presentation, hero layout and hero actions
-- inside the existing locale-owned draft/publish content flow.
...
comment on function public.save_public_site_draft_v22(uuid, text, jsonb, boolean) is
  'Normalizes and saves public-site drafts, including hero and header presentation fields.';
