-- OneStudio OS Configured Workspace P0 Hotfix
-- Keeps the clean local baseline deterministic and prevents a nullable
-- normalization result from breaking public-site draft persistence.
