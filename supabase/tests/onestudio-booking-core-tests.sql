...
select is((select version from public.business_modules where business_id='62000000-0000-4000-8000-000000000001' and module_key='scheduling'), '1.1.0', 'scheduling records booking core version');
