        ...
        <section id="hero" className={styles.hero}>
          ...
          <VowReveal className={styles.heroCopy}>
            ...
            <div className={styles.heroActions}>
              <Link className={styles.goldButton} data-premium-action={premiumNativeActionKey("vow-films", "hero", "primary-action")} href={content.hero.primaryUrl}>{content.hero.primaryLabel}</Link>
              <Link className={styles.textButton} data-premium-action={premiumNativeActionKey("vow-films", "hero", "secondary-action")} href={content.hero.secondaryUrl}>{content.hero.secondaryLabel} <span aria-hidden="true">↗</span></Link>
            </div>
          </VowReveal>
