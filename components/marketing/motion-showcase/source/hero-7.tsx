...
// Licensed source component from the premium library. The preview only swaps
// the official remote demo image URLs for existing local landing assets.
...
function ResizeHandler() {
  ...
  useEffect(() => {
    ...
    const timeoutIds = [100, 300, 1000].map((delay) =>
      window.setTimeout(updateSize, delay),
    );
