...
export const pricing9ContentDefaults = {
...
export type AdaptedPricing9Props = { [K in keyof typeof pricing9ContentDefaults]: string };

export default function AdaptedPricing9({ eyebrow, headingLine1, headingLine2, description, saveBadge, annualTitle, annualPrice, annualDescription, monthlyTitle, monthlyPrice, monthlyDescription, helperText, termsLabel, cancelLabel, buttonLabel }: AdaptedPricing9Props) {
        ...
        <div className="mt-10 grid grid-cols-1 md:grid-cols-2 gap-4 w-full max-w-3xl">
          ...
          >
            ...
            <div className="flex items-start justify-between gap-4">
              <div>
                <p className="font-semibold">{annualTitle}</p>
                <p className="mt-1 font-semibold text-xl">{annualPrice}</p>
                <p
          ...
          >
            <div className="flex items-start justify-between gap-4">
              <div>
                <p className="font-semibold">{monthlyTitle}</p>
                <p className="mt-1 font-semibold text-xl">{monthlyPrice}</p>
                <p
