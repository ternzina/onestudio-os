...
export const contact8Expectations = [
...
export const contact8Reviewers = [
  {
...
export const contact8ContentDefaults = {
  headingLead: "A quieter way to",
  headingTail: "run your operations",
};

export default function AdaptedContact8({
  expectations = contact8Expectations,
  reviewers = contact8Reviewers,
  headingLead = contact8ContentDefaults.headingLead,
  headingTail = contact8ContentDefaults.headingTail,
}: {
  expectations?: Array<{ text: string }>;
  reviewers?: Array<{ src: string; name: string; role: string }>;
  headingLead?: string;
  headingTail?: string;
}) {
  return (
    <section className="w-full min-h-[var(--rb-section-min-h,100vh)] flex items-start py-12 sm:py-16 px-4 sm:px-6 lg:px-8 bg-white dark:bg-neutral-950">
      <div className="max-w-[1400px] mx-auto w-full">
        <div data-rb-layout-grid-target="true" className="grid grid-cols-1 lg:grid-cols-2 gap-10 lg:gap-16 items-center">
          <motion.div
