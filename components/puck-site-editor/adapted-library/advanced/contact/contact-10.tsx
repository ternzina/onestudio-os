...
export type Contact10Benefit = { title: string; description: string };
export const contact10Benefits: Contact10Benefit[] = [
  {
...
export const contact10ContentDefaults = {
  headingLead: "Turn insights",
  headingTail: "into action",
  description:
    "Connect with a specialist to unify your research, reports, and feedback into one secure workflow, and see the outcomes that actually move the roadmap.",
};

export default function AdaptedContact10({
  benefits = contact10Benefits,
  headingLead = contact10ContentDefaults.headingLead,
  headingTail = contact10ContentDefaults.headingTail,
  description = contact10ContentDefaults.description,
}: {
  benefits?: Contact10Benefit[];
  headingLead?: string;
  headingTail?: string;
  description?: string;
}) {
