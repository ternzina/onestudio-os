...
export const blog2Articles: Blog2Article[] = [
  {
    id: 1,
...
export const blog2ContentDefaults = { heading: "Recently published" };

export function AdaptedBlog2({
  articles = blog2Articles,
  heading = blog2ContentDefaults.heading,
}: {
  articles?: Blog2Article[];
  heading?: string;
}) {
