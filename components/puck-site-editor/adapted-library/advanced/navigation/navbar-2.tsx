...
export const navbar2Filters = [
  { text: "Assigned to me" },
  { text: "Due this week" },
  { text: "Blocked" },
];

export const navbar2Rows = [
...
export default function AdaptedNavbar2({
  sorts = navbar2Sorts,
  filterOptions = navbar2Filters,
  rows = navbar2Rows,
}: {
  sorts?: Array<{ id: string; label: string }>;
  filterOptions?: Array<{ text: string }>;
