...
export type AdaptedWaitlist3Props = {
  heading: string;
  description: string;
...
export const waitlist3ContentDefaults: AdaptedWaitlist3Props = {
  heading: "Join the waitlist for early access.",
  description:
    "Be among the first to experience our new platform. Join our exclusive waitlist and get notified when we launch.",
  emailPlaceholder: "Enter your email",
  buttonLabel: "Join the waitlist",
  submittingLabel: "Joining...",
};

export default function AdaptedWaitlist3({
  heading,
  description,
  emailPlaceholder,
  buttonLabel,
  submittingLabel,
}: AdaptedWaitlist3Props) {
              ...
              <div className="flex flex-col items-center space-y-6">
                ...
                >
                  ...
                  <button
                    type="submit"
                    disabled={isSubmitting}
                    aria-label={isSubmitting ? "Submitting" : buttonLabel}
