...
export const contact12ContentDefaults = {
...
export type AdaptedContact12Props = { [K in keyof typeof contact12ContentDefaults]: string };
...
export default function AdaptedContact12({ heading, description, responseValue, responseLabel }: AdaptedContact12Props) {
