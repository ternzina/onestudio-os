...
import { hero16ContentDefaults } from "../../content-editability-batch-4-contracts";

export type AdaptedHero16Props = typeof hero16ContentDefaults;

export default function AdaptedHero16({
  logoUrl,
  logoAlt,
  headingLine1,
  headingLine2,
  ...
  primaryButtonHref,
  secondaryButtonHref,
}: AdaptedHero16Props = hero16ContentDefaults) {
      ...
      <div className="max-w-[1400px] mx-auto w-full flex flex-col flex-1">
        ...
        <div className="flex-1 flex items-start pt-12 sm:pt-16 md:pt-20">
          ...
          >
            ...
            <br />
            {headingLine2}
            <br className="hidden sm:block" /> {headingLine3}
          </motion.h1>
        </div>
