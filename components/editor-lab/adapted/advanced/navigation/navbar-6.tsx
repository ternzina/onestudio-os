...
export default function AdaptedNavbar6({
  notices = navbar6Notices,
  results = navbar6Results,
}: {
  notices?: Array<{ id: string; who: string; text: string; at: string }>;
  ...
  const matches = results.filter((result) =>
    result.text.toLowerCase().includes(query.trim().toLowerCase()),
  );
