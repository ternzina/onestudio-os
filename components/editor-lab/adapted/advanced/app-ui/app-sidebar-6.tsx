...
export type AppSidebar6IconToken = keyof typeof appSidebar6Icons;
export type AppSidebar6Group = {
  label: string;
  items: Array<{
    label: string;
    iconToken: AppSidebar6IconToken;
    current?: boolean;
    badge?: string;
  }>;
};

export const appSidebar6Groups: AppSidebar6Group[] = [
  {
    label: "Today",
    items: [
      { label: "Home", iconToken: "home", current: true },
      { label: "Inbox", iconToken: "inbox", badge: "6" },
      { label: "Schedule", iconToken: "calendar" },
      { label: "Tasks", iconToken: "tasks", badge: "4" },
    ],
  },
  {
    label: "Workspace",
    items: [
      ...
      { label: "Knowledge base", iconToken: "knowledge" },
      { label: "Team", iconToken: "team" },
    ],
  },
  {
    label: "Account",
    items: [
      { label: "Notifications", iconToken: "bell" },
      { label: "Settings", iconToken: "settings" },
      { label: "Help & support", iconToken: "help" },
    ],
  },
];

export default function AdaptedAppSidebar6({
  groups = appSidebar6Groups,
}: {
  groups?: AppSidebar6Group[];
}) {
                  ...
                  <div key={group.label}>
                    ...
                    <ul className="space-y-0.5">
                      {group.items.map((item) => {
                        const Icon = resolveIconToken(item.iconToken, appSidebar6Icons);
