...
export type AppShell9Turn = { role: "user" | "assistant"; text: string };

export const appShell9ChatIcons = {
  file: FileText,
  code: Code2,
  location: MapPin,
...
export type AppShell9IconToken = keyof typeof appShell9ChatIcons;
export type AppShell9Chat = {
  id: string;
  title: string;
  iconToken: AppShell9IconToken;
  model: string;
  count: number;
  turns: AppShell9Turn[];
};

export const appShell9Chats: AppShell9Chat[] = [
  {
    id: "revenue",
...
function SidebarBody({
  ...
  const PinnedIcon = resolveIconToken(pinned.iconToken, appShell9ChatIcons);
        ...
        >
          ...
          <div className="pb-4">
            ...
            <ul className="space-y-0.5">
              {chats.map((chat) => {
                const ChatIcon = resolveIconToken(chat.iconToken, appShell9ChatIcons);
...
export default function AdaptedAppShell9({
  chats = appShell9Chats,
}: {
  chats?: AppShell9Chat[];
}) {
