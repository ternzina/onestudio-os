...
export const ecommerce1ContentDefaults = {
...
export default function AdaptedEcommerce1({
  views = ecommerce1Views,
  productName = ecommerce1ContentDefaults.productName,
  brand = ecommerce1ContentDefaults.brand,
  price = ecommerce1ContentDefaults.price,
  stockLabel = ecommerce1ContentDefaults.stockLabel,
  backLabel = ecommerce1ContentDefaults.backLabel,
}: {
  views?: Array<{ src: string }>;
  productName?: string;
  brand?: string;
  price?: string;
  stockLabel?: string;
      ...
      <div className="max-w-[1400px] mx-auto w-full grid grid-cols-1 lg:grid-cols-[1fr_360px] gap-5 items-start">
        <div className="relative rounded-3xl bg-neutral-100 dark:bg-neutral-900 overflow-hidden aspect-4/5 sm:aspect-4/3 lg:aspect-auto lg:min-h-[720px]">
          ...
          <AnimatePresence mode="wait">
            <motion.img
              key={thumb}
              src={views[thumb]?.src ?? ecommerce1Views[0].src}
              alt=""
