...
export const ecommerce2Products: Product[] = [
  {
    name: "Slim Air Fryer 4qt",
    price: "$59.99",
    tag: "Bestseller",
    brand: "Hearth",
    colors: [{ value: "#111" }, { value: "#e7e2d8" }, { value: "#3f5c4a" }, { value: "#8b3a2f" }],
    chips: [{ value: "Fits-anywhere" }, { value: "EverGood" }],
    image:
  ...
  },
  {
    ...
    tag: "Bestseller",
    brand: "Hearth PRO",
    colors: [{ value: "#111" }, { value: "#e7e2d8" }],
    chips: [{ value: "EverGood" }, { value: "Premium" }, { value: "Fits-anywhere" }],
    image:
  ...
  },
  {
    ...
    colors: [{ value: "#111" }],
    chips: [{ value: "Family size" }, { value: "EverGood" }],
    image:
  ...
  },
  {
    ...
    tag: "Bestseller",
    brand: "Hearth PRO",
    colors: [{ value: "#111" }, { value: "#e7e2d8" }, { value: "#8b3a2f" }],
    chips: [{ value: "Family size" }, { value: "EverGood" }, { value: "Premium" }],
    image:
  ...
  },
  {
    ...
    colors: [{ value: "#111" }, { value: "#e7e2d8" }, { value: "#3f5c4a" }],
    chips: [],
    image:
...
export default function AdaptedEcommerce2({
  products = ecommerce2Products,
}: {
  products?: Product[];
}) {
