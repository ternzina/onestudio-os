...
export const blog1Articles: Blog1Article[] = [
  {
    id: 1,
...
export const blog1ContentDefaults = {
  heading: "Blog",
  description:
    "Read our latest articles and insights on the latest trends and developments in the industry.",
  listHeading: "Latest Articles",
};

export function AdaptedBlog1({
  articles = blog1Articles,
  heading = blog1ContentDefaults.heading,
  description = blog1ContentDefaults.description,
  listHeading = blog1ContentDefaults.listHeading,
}: {
  articles?: Blog1Article[];
  heading?: string;
  description?: string;
  listHeading?: string;
}) {
