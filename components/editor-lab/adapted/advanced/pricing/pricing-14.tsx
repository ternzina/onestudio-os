...
export const pricing14Icons = {
  analytics: ChartLine,
  automation: Workflow,
  support: Headset,
  security: ShieldCheck,
} as const;
export type Pricing14IconToken = keyof typeof pricing14Icons;
export type Pricing14Addon = {
  id: string;
  iconToken: Pricing14IconToken;
  name: string;
  blurb: string;
  price: number;
};

export const pricing14Addons: Pricing14Addon[] = [
  {
    id: "analytics",
    iconToken: "analytics",
...
export default function AdaptedPricing14({
  addons = pricing14Addons,
}: {
  addons?: Pricing14Addon[];
}) {
          ...
          <div>
            ...
            <div className="mt-4 space-y-3">
              {addons.map((addon) => {
                ...
                const Icon = resolveIconToken(addon.iconToken, pricing14Icons);
                return (
                  <motion.button
                    key={addon.id}
                    variants={item}
