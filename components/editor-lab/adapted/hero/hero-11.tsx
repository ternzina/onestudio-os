...
export const hero11ContentDefaults = {
  badge: "New",
...
export type AdaptedHero11Props = { [K in keyof typeof hero11ContentDefaults]: string };
...
export function AdaptedHero11({ badge, announcement, heading, description, primaryButtonLabel, secondaryButtonLabel, mediaUrl }: AdaptedHero11Props) {
  return (
