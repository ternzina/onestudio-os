...
export const hero14ContentDefaults = {
  rating: "5 stars",
...
export type AdaptedHero14Props = { [K in keyof typeof hero14ContentDefaults]: string };

export function AdaptedHero14({ rating, reviews, headingLine1, headingLine2, description, emailPlaceholder, buttonLabel, linkLabel, mediaUrl }: AdaptedHero14Props) {
