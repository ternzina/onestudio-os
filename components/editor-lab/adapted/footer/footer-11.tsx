...
export const footer11ContentDefaults = {
  brandInitial: "A",
  brandName: "Aster",
...
export type AdaptedFooter11Props = { [K in keyof typeof footer11ContentDefaults]: string };
...
export default function AdaptedFooter11({ brandInitial, brandName, description }: AdaptedFooter11Props) {
