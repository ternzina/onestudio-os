...
export const card8ContentDefaults = {
  clearLabel: "Clear",
  downloadLabel: "Download",
};

export type AdaptedCard8Props = { [K in keyof typeof card8ContentDefaults]: string };
...
export default function AdaptedCard8({ clearLabel, downloadLabel }: AdaptedCard8Props) {
