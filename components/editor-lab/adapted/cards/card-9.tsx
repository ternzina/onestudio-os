...
export const card9ContentDefaults = {
  initials: "SR",
  name: "Sam Rivera",
...
export type AdaptedCard9Props = { [K in keyof typeof card9ContentDefaults]: string };
...
export default function AdaptedCard9({ initials, name, role, location, bio, followLabel, followingLabel, messageLabel }: AdaptedCard9Props) {
