...
export type Card10SplitItem = { label: string; value: string };
export type Card10ActivityItem = { id: string; name: string; when: string; amount: string; incoming: boolean };

export const card10ContentDefaults = {
...
export type AdaptedCard10Props = { [K in keyof typeof card10ContentDefaults]: string } & {
  split: Card10SplitItem[];
  activity: Card10ActivityItem[];
};
...
export const card10SplitDefaultItems: Card10SplitItem[] = [
  { label: "Pending", value: "$1,204.00" },
  { label: "Reserved", value: "$380.00" },
];

export const card10ActivityDefaultItems: Card10ActivityItem[] = [
  {
    id: "stripe",
    name: "Stripe payout",
    when: "Today, 09:14",
...
export default function AdaptedCard10({ balanceLabel, balanceValue, changeValue, balanceMeta, addButtonLabel, transferButtonLabel, split, activity }: AdaptedCard10Props) {
  return (
