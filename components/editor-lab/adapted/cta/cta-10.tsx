...
export const cta10ContentDefaults = {
...
export type AdaptedCta10Props = { [K in keyof typeof cta10ContentDefaults]: string };

export default function AdaptedCta10({ heading, description, emailPlaceholder, buttonLabel, mediaUrl }: AdaptedCta10Props) {
  return (
