...
export const socialProof13ContentDefaults = {
...
export type AdaptedSocialProof13Props = { [K in keyof typeof socialProof13ContentDefaults]: string };
...
export default function AdaptedSocialProof13({ eyebrow, heading, description, moreLabel }: AdaptedSocialProof13Props) {
  return (
