...
export const socialProof14ContentDefaults = {
...
export type AdaptedSocialProof14Props = { [K in keyof typeof socialProof14ContentDefaults]: string };
...
export default function AdaptedSocialProof14({ heading, description, ratingValue, reviewsLabel, buttonLabel }: AdaptedSocialProof14Props) {
  return (
