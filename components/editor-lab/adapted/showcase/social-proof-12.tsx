...
export const socialProof12ContentDefaults = {
...
export type AdaptedSocialProof12Props = { [K in keyof typeof socialProof12ContentDefaults]: string };
...
export default function AdaptedSocialProof12({ heading, description, buttonLabel }: AdaptedSocialProof12Props) {
  return (
