...
export const about10ContentDefaults = {
...
export type AdaptedAbout10Props = { [K in keyof typeof about10ContentDefaults]: string };
...
export default function AdaptedAbout10({ eyebrow, headingLead, headingBrand, description, buttonLabel, partnersLabel }: AdaptedAbout10Props) {
    ...
    <section className="w-full min-h-[var(--rb-section-min-h,100vh)] flex items-start py-16 sm:py-20 lg:py-24 px-4 sm:px-6 lg:px-8 bg-white dark:bg-neutral-950">
      <div className="max-w-[1400px] mx-auto w-full">
        ...
        >
          ...
          >
            <span className="text-neutral-950 dark:text-white">{headingLead}</span>
