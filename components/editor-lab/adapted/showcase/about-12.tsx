...
export const about12ContentDefaults = {
...
export type AdaptedAbout12Props = { [K in keyof typeof about12ContentDefaults]: string };
...
export default function AdaptedAbout12({ eyebrow, quote, authorName, authorRole, description }: AdaptedAbout12Props) {
