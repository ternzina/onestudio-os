...
export const socialProof16ContentDefaults = {
...
export type AdaptedSocialProof16Props = { [K in keyof typeof socialProof16ContentDefaults]: string };
...
export default function AdaptedSocialProof16({ featuredQuote, featuredName, featuredRole, companyLabel }: AdaptedSocialProof16Props) {
  return (
        ...
        >
          ...
          <div className="mt-8 flex items-center gap-4 lg:mt-auto lg:pt-10">
            ...
            <div>
              ...
              <p className="text-sm text-neutral-400">{featuredRole}</p>
            </div>
          </div>
