...
const showcaseBlocks = [
  ...
  block({ type: "RB_batch12_blog_2", displayName: "React Bits Blog 2", catalogKey: "pro-block:blog-2", description: "Official React Bits Blog 2 paginated media list.", component: Blog2 as unknown as AnyComponent, tags: ["React Bits Fast Batch 12", "Showcase", "Blog"], batchGroup: "SHOWCASE / MEDIA", host: marketingHost }),
...
const navigationBlocks = [
  ...
  block({ type: "RB_batch12_navbar_2", displayName: "React Bits Navbar 2", catalogKey: "pro-block:navbar-2", description: "Official React Bits App UI Navbar 2.", component: Navbar2 as unknown as AnyComponent, tags: ["React Bits Fast Batch 12", "Navigation", "App UI"], batchGroup: "NAV / CTA / FOOTER", host: appHost(400) }),
  ...
  block({ type: "RB_batch12_navbar_4", displayName: "React Bits Navbar 4", catalogKey: "pro-block:navbar-4", description: "Official React Bits App UI Navbar 4.", component: Navbar4 as unknown as AnyComponent, tags: ["React Bits Fast Batch 12", "Navigation", "App UI"], batchGroup: "NAV / CTA / FOOTER", host: appHost(560) }),
  ...
  block({ type: "RB_batch12_navbar_6", displayName: "React Bits Navbar 6", catalogKey: "pro-block:navbar-6", description: "Official React Bits App UI Navbar 6.", component: Navbar6 as unknown as AnyComponent, tags: ["React Bits Fast Batch 12", "Navigation", "App UI"], batchGroup: "NAV / CTA / FOOTER", host: appHost(480) }),
];
...
const appBlocks = [
  block({ type: "RB_batch12_app_shell_9", displayName: "React Bits App Shell 9", catalogKey: "pro-block:app-shell-9", description: "Official React Bits App Shell 9.", component: AppShell9 as unknown as AnyComponent, tags: ["React Bits Fast Batch 12", "App Shell", "App UI"], batchGroup: "APP / CONTENT", host: appHost(720) }),
