...
const libraryGroupOrder = ["React Bits Control 3", "React Bits Control 6", "React Bits Fast Batch 1", "React Bits Fast Batch 2", "React Bits Fast Batch 3", "React Bits Fast Batch 4", "React Bits Fast Batch 5", "React Bits Fast Batch 6", "React Bits Fast Batch 7", "React Bits Fast Batch 8", "Official React Bits", "Marketing Blocks", "Experimental / Current-free"];
const collapsedByDefault = new Set(["React Bits Fast Batch 1", "React Bits Fast Batch 2", "React Bits Fast Batch 3", "React Bits Fast Batch 4", "React Bits Fast Batch 5", "React Bits Fast Batch 6", "React Bits Fast Batch 7", "React Bits Fast Batch 8", "Official React Bits", "Marketing Blocks", "Experimental / Current-free"]);
