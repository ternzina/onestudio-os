...
export type Contact2Props = { heading?: string; formHeading?: string; studioName?: string; address?: string };
export default function Contact2({ heading = "Ready to create something amazing?", formHeading = "Contact us", studioName = "Pixel Studio Creative", address = "42 Design Ave, San Francisco, CA" }: Contact2Props = {}) {
