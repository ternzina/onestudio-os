...
export function OneStudioSeoDialog({ open, businessId, draft, canConfigure, saving, publicOrigin, onChange, onSave, onClose }: SeoDialogProps) {
  const { t } = useAdminI18n();
