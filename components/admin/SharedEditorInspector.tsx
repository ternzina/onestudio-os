...
export function SharedEditorInspectorField({ field, headingRichText = false }: { field: EditorInspectorField; headingRichText?: boolean }) {
  ...
  if (field.type === "action") return <SiteEditorActionField label={field.label} text={field.text} href={field.href} originalText={field.originalText} originalHref={field.originalHref} disabled={field.disabled} destinations={field.destinations} destinationHint={field.destinationHint} onTextChange={field.onTextChange} onHrefChange={field.onHrefChange} />;
