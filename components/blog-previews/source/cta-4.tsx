...
export type CTA4Props = { heading?: string; description?: string; ctaLabel?: string };
export default function Cta4({ heading = "protect the digital world", description = "Join our elite cybersecurity team to defend against the most sophisticated threats and protect businesses.", ctaLabel = "Join our team" }: CTA4Props = {}) {
  const images = [
    {
      id: 1,
  ...
  return (
    <section className="w-full min-h-[var(--rb-section-min-h,100vh)] flex flex-col items-center bg-white dark:bg-neutral-950 overflow-visible px-4 sm:px-6 lg:px-8">
      <div className="max-w-[1400px] mx-auto w-full flex items-center justify-center py-12 sm:py-16 md:py-20 lg:py-24">
