...
export type Footer4Props = { heading?: string; newsletterHeading?: string };
type FooterLink = { text: string; href?: string };

export default function Footer4({ heading = "Decentralized finance. One block at a time.", newsletterHeading = "Stay updated on protocol developments." }: Footer4Props = {}) {
