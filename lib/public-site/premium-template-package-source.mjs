...
export const PREMIUM_TEMPLATE_PACKAGE_SOURCE = [
  ...
  },
  {
    manifest: {
      ...
      description:
        "Премиальный beauty-салон с услугами, мастерами, галереей и онлайн-записью.",
      category: "beauty",
      aliases: ["lumea", "lumea-beauty-studio"],
      library: { tier: "premium", visible: true, order: 20 },
      preview: {
        collectionVisible: true,
        group: "beauty",
        order: 20,
        title: { ru: "Салон красоты", en: "Beauty studio" },
        description: {
    ...
    bindings: {
      ...
      customPage: {
        module: "lib/public-site/lumea-premium-template-custom-page-runtime-adapter.ts",
