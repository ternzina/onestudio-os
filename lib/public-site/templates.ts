...
export const GLOSS_TEMPLATE: SiteTemplate = {
  ...
  content: {
    ...
    hero_layout: "split",
    hero_image_placement: "right",
    hero_image_position: "center",
    hero_image_fit: "cover",
    hero_primary_label: "Записаться",
    hero_primary_url: "",
    hero_secondary_label: "Выбрать дизайн",
    ...
    portfolio_columns: 3,
    portfolio_card_aspect: "auto",
    portfolio_show_filters: true,
    portfolio_lightbox: true,
    portfolio_show_category: true,
    portfolio_show_title: true,
    portfolio_show_description: false,
    portfolio_home_limit: 9,
    team_label: "Мастера",
    ...
    contact_phone: "",
    contact_note: "",
    contact_route_label: "Построить маршрут",
    map_query: "ул. Вишнёвая, 11",
    footer_note: "Красота в деталях, забота в каждом визите.",
    show_services: true,
    show_portfolio: true,
    show_team: true,
    show_reviews: true,
