...
export function createLumeaPremiumTemplateSeed(locale = "ru"): PublicSiteContent {
  ...
  const base = {
    ...
    seo_description: english
      ? "Independent beauty studio for hair, skin, brows, lashes and slow care rituals with convenient online booking."
      : "Независимая beauty studio: волосы, уход за кожей, брови, ресницы и slow beauty ритуалы. Онлайн-запись в LUMÉA.",
    seo_image_url: template.hero.image,
    seo_keywords: english
      ? "beauty studio, hair, skincare, brows, lashes, slow beauty"
      : "beauty studio, волосы, уход за кожей, брови, ресницы, slow beauty",
