...
export const common = {
  ...
  footer: {
    ...
    links: { features: "Funciones", solutions: "Soluciones", templates: "Plantillas", components: "Componentes", pricing: "Precios", about: "Sobre OneStudio", website: "Sitio web llave en mano", faq: "FAQ", journal: "Diario", contact: "Contacto", privacy: "Privacidad", terms: "Condiciones" }, copyright: "© OneStudio OS - Todos los derechos reservados",
  },
  ...
  metadata: {
    ...
    journal: { title: "Diario - OneStudio OS", description: "Nuevos componentes, posibilidades de diseño y novedades de OneStudio: breve y útil." },
