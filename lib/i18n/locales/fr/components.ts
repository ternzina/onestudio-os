...
export const components = { ...englishComponents, page: { eyebrow: "COMPOSANTS", titleBefore: "Plus de façons", titleAccent: "de présenter votre activité.", lead: "Blocs prêts à l’emploi, éléments interactifs et effets visuels pour vos pages OneStudio.", catalogEyebrow: "BIBLIOTHÈQUE", catalogTitle: "Choisissez le bon bloc.", catalogLead: "Aperçus en direct des composants réels de la bibliothèque OneStudio actuelle.", categoryLabel: "Catégories de composants", all: "Tous", previewLabel: "Aperçu",
    ...
    "glue-dots": { label: "Glue Dots", description: "Des points souples fusionnent, suivent le pointeur et propagent des ondes." },
    "device": { label: "Device", description: "Une maquette de téléphone soignée avec parallaxe et légère rotation au survol." },
    "gradient-carousel": { label: "Gradient Carousel", description: "Un carrousel d’images en profondeur avec un dégradé lié à la carte active." },
    "liquid-ascii": { label: "Liquid ASCII", description: "Un champ ASCII liquide se déforme et s’écoule autour du pointeur." },
    "magic-transform": { label: "Magic Transform", description: "Des documents traversent un transformateur visuel et deviennent des résultats structurés." },
    "text-scatter": { label: "Text Scatter", description: "Les lettres s’écartent du pointeur puis reviennent avec un effet ressort." },
    "modal-cards": { label: "Modal Cards", description: "Des cartes interactives s’ouvrent dans une vue modale détaillée." },
    "scroll-mask": { label: "Scroll Mask", description: "L’image se révèle au défilement avec un masque doux et un léger zoom." },
    "dot-shift": { label: "Dot Shift", description: "Des points shader se déplacent doucement dans un champ numérique." },
  } } as const;
