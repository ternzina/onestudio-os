...
export const components = {
  ...
  items: {
    ...
    "glue-dots": { label: "Glue Dots", description: "М’які точки зливаються, тягнуться до курсора й розходяться хвилями." },
    "device": { label: "Device", description: "Акуратний макет телефона з легким паралаксом і нахилом при наведенні." },
    "gradient-carousel": { label: "Gradient Carousel", description: "Об’ємна фотогалерея з градієнтом, що змінюється разом з активною карткою." },
    "liquid-ascii": { label: "Liquid ASCII", description: "Рідке ASCII-поле вигинається й тече за рухом курсора." },
    "magic-transform": { label: "Magic Transform", description: "Документи проходять крізь візуальний трансформер і стають структурованими результатами." },
