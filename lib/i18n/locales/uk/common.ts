...
export const common = {
  ...
  footer: {
    ...
    links: { features: "Можливості", solutions: "Рішення", templates: "Шаблони", components: "Компоненти", pricing: "Тарифи", about: "Про OneStudio", website: "Сайт під ключ", faq: "FAQ", journal: "Журнал", contact: "Контакти", privacy: "Конфіденційність", terms: "Умови" },
  ...
  metadata: {
    ...
    journal: { title: "Журнал - OneStudio OS", description: "Нові компоненти, можливості дизайну та оновлення OneStudio: коротко й по суті." },
