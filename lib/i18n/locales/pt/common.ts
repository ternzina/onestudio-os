...
export const common = {
  ...
  footer: {
    ...
    links: { features: "Funcionalidades", solutions: "Soluções", templates: "Modelos", components: "Componentes", pricing: "Preços", about: "Sobre o OneStudio", website: "Site chave na mão", faq: "FAQ", journal: "Diário", contact: "Contacto", privacy: "Privacidade", terms: "Termos" }, copyright: "© OneStudio OS - Todos os direitos reservados",
  },
  ...
  metadata: {
    ...
    journal: { title: "Diário - OneStudio OS", description: "Novos componentes, possibilidades de design e novidades do OneStudio: de forma breve e útil." },
