            ...
            <div className="mt-5 grid gap-8 lg:grid-cols-[1.2fr_0.8fr] lg:items-end">
              <div>
                <h1 className="text-4xl font-semibold tracking-[-0.06em] sm:text-6xl">
                  {t("Every booking grows one client history.")}
                </h1>
                <p className="mt-5 max-w-3xl text-sm leading-7 text-white/68 sm:text-base">
                  {t("Keep contacts, language, tags, notes and booking history in one canonical client record. Duplicate identities can be reviewed and merged without losing reservations.")}
                </p>
              </div>
              <div className="rounded-[26px] border border-white/10 bg-white/[0.07] p-5">
                ...
                <p className="mt-3 text-xl font-semibold">
                  {t("One client, one history.")}
                </p>
                <p className="mt-2 text-sm leading-6 text-white/62">
                  {t("Public and administrative bookings reuse the same identity. Email uniqueness, matching name and phone checks, archive rules and protected merges keep the client list clean.")}
                </p>
              </div>
            </div>
          </div>
