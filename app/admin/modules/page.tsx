      ...
      <main className="min-h-screen px-5 pb-24 pt-36">
        <section className="mx-auto w-full max-w-7xl">
          <div className="rounded-[36px] bg-[#17191f] p-7 text-white shadow-[0_28px_90px_rgba(20,20,20,0.18)] sm:p-10">
            <p className="text-xs font-semibold uppercase tracking-[0.28em] text-[#d8b36a]">{t("Resend Adapter 1.0")}</p>
            <div className="mt-5 grid gap-8 lg:grid-cols-[1.25fr_0.75fr] lg:items-end">
              ...
              <div className="rounded-[26px] border border-white/10 bg-white/[0.07] p-5">
                ...
                <p className="mt-3 text-lg font-semibold">{t("Disabled first, test next, live only when explicitly enabled.")}</p>
                <p className="mt-2 text-sm leading-6 text-white/62">{t("The adapter defaults to disabled and never exposes API keys in the browser.")}</p>
              </div>
            </div>
          </div>
