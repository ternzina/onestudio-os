...
export async function generateMetadata({
  ...
  return locale === "en"
    ? {
        ...
        description: "Beauty salon for hair, nails, skincare, brows and lashes with convenient online booking.",
      }
    : {
        title: "LUMÉA Beauty Studio — салон красоты",
        description: "Премиальный салон красоты: волосы, маникюр, косметология, брови и ресницы. Онлайн-запись к мастерам LUMÉA.",
      };
}
  ...
  return (
    <>
      <div className="fixed right-3 bottom-5 left-3 z-[90] flex justify-end sm:left-auto sm:right-5">
        <Link
          className="max-w-full rounded-full bg-[#5A2D17] px-5 py-3 text-center text-sm font-semibold break-words text-white shadow-2xl"
