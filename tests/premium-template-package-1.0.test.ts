...
const KEYS = ["pawhaus-grooming-studio", "ritmo-dance-studio", "align-pilates-studio", "gloss-nail-studio", "premium-studio", "velora-event-venue", "vow-films", "lumea-beauty", "rastem-center"] as const;
