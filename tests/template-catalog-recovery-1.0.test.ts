...
test("one canonical catalog owns all executable customer designs", () => {
  ...
  assert.deepEqual(TEMPLATE_KEYS, ["standard", "align-pilates-studio", "gloss-nail-studio", "premium-kids-center", "lumea-beauty", "premium-studio", "velora-event-venue", "vow-films"]);
